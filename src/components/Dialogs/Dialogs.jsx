...
const dialogsEl = dialogsData.map(person => <DialogItem id={person.id} name={person.name}></DialogItem>)

const messagesEl = messagesData.map(el => <Message message={el.message}></Message>)
